 ...
 * 
 * IMPORTANT! YOU MUST MEMOIZE the inputted targetRefOrQuery using `useMemoFirebase`
 * or this hook will cause infinite re-renders.
 *  
 * @template T Optional type for document data. Defaults to any.
 * @param {CollectionReference<DocumentData> | Query<DocumentData> | null | undefined} targetRefOrQuery -
 * The Firestore CollectionReference or Query. Must be memoized. Waits if null/undefined.
